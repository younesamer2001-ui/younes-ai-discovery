...
export default function PricingPage() {
  ...
  const tx = lang === 'no' ? {
    ...
    guaranteeDesc: 'Vi justerer og optimaliserer til du er 100% forn\u00f8yd med l\u00f8sningen. Ved \u00e5rsbetaling f\u00e5r du 30 dagers pengene-tilbake-garanti. M\u00e5nedlig drift har ingen bindingstid \u2014 du kan avslutte n\u00e5r som helst.',
    guaranteeItems: ['30 dagers garanti ved \u00e5rsbetaling', 'Ingen bindingstid p\u00e5 m\u00e5nedlig', 'GDPR-sikret', 'Norsk datasenter'],
    ...
    guaranteeDesc: 'We adjust and optimize until you are 100% satisfied with the solution. Annual billing includes a 30-day money-back guarantee. Monthly plans have no lock-in \u2014 cancel anytime.',
    guaranteeItems: ['30-day guarantee on annual plans', 'No lock-in on monthly', 'GDPR compliant', 'Norwegian data center'],
